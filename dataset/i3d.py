...
class InceptionI3D_Data(Dataset):
    ...
    def read_videos(self,name):
        ...
        if not os.path.exists(path):
            return None  # Return None nếu file không tồn tại
    ...
    def __getitem__(self, idx):
        ...
        # Nếu video không tồn tại, thử video tiếp theo
        if clip is None:
            # Lấy index khác, tránh infinite loop
            new_idx = (idx + 1) % len(self.train_labels)
